...
<head>
      <title>Curso JSP - ArfaxTechSoft</title>
      ...
      <meta name="description" content="Projeto desenvolvido em JSP" />
      <meta name="keywords" content="bootstrap, bootstrap admin template, admin theme, admin dashboard, dashboard template, admin template, responsive" />
      <meta name="author" content="Leandro Amorim Batista" />
      
      <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
      <!-- Favicon icon -->
      <link rel="icon" href="<%= request.getContextPath() %>/assets/images/favicon.ico" type="image/x-icon">
      <!-- Google font-->
      <link href="https://fonts.googleapis.com/css?family=Ubuntu:400;600;700" rel="stylesheet">
      <!-- waves.css -->
